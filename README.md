...
- I don’t want cloud APIs, accounts, or background uploads.
- This project explores what a **local-first AI assistant** feels like on a personal computer.

## 🧩 Features
- 🧠 Local LLM via Ollama (offline, no API key)
- 🪟 Desktop-native window (always available, non-intrusive)
- 🗂️ Local memory (stored on device)
- 🔒 No cloud, no telemetry, no background upload
